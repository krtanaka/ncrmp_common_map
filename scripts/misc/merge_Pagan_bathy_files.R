...
b1 = rast("N:/GIS/Projects/CommonMaps/Bathymetry/cnmi2019_fdm_pagan_Job1075178_merged.tif"); plot(b1)
b2 = rast("N:/GIS/Projects/SeafloorCalc/Final_Products/pag_inpo/w001001.adf"); plot(b2)
