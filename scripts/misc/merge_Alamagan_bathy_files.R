...
b1 = rast("N:/GIS/Projects/CommonMaps/Bathymetry/2020_ngs_topobathy_alamagan_Job1075170.tif"); plot(b1)
b2 = rast("N:/GIS/Projects/SeafloorCalc/Workspace/Alamagan/ala_inpo_mbik/w001001.adf"); plot(b2)
