...
b1 = raster("N:/GIS/Projects/SeafloorCalc/Workspace/Supply/sup_10m/w001001.adf"); plot(b1); res(b1)
b2 = raster("N:/GIS/Projects/CommonMaps/Bathymetry/Supply_10m.asc"); plot(b2); res(b2)
