...
b6 = rast("N:/GIS/Projects/CommonMaps/Bathymetry/2022_rainier_asuncion/H13581_MBAB_2m_2803_300kHz_1of4.tif"); plot(b6); res(b6)
b7 = rast("N:/GIS/Projects/CommonMaps/Bathymetry/2022_rainier_asuncion/H13581_MBAB_2m_2804_300kHz_2of4.tif"); plot(b7); res(b7)
b8 = rast("N:/GIS/Projects/CommonMaps/Bathymetry/2022_rainier_asuncion/H13581_MBAB_3m_2804_200kHz_3of4.tif"); plot(b8); res(b8)
b9 = rast("N:/GIS/Projects/CommonMaps/Bathymetry/2022_rainier_asuncion/H13581_MBAB_6m_S221_100kHz_4of4.tif"); plot(b9); res(b9)
...
b1 = resample(b1, b9, method = "near"); plot(b1)
b2 = resample(b2, b9, method = "near"); plot(b2)
b3 = resample(b3, b9, method = "near"); plot(b4)
b4 = resample(b4, b9, method = "near"); plot(b5)
b5 = resample(b5, b9, method = "near"); plot(b6)
b6 = resample(b6, b9, method = "near"); plot(b7)
b7 = resample(b7, b9, method = "near"); plot(b8)
b8 = resample(b8, b9, method = "near"); plot(b9)
