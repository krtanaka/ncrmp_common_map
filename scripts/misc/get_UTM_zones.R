...
ncrmp_utm_zones$Satellite = ifelse(ncrmp_utm_zones$Island %in% c("Guam", "Tutuila", "Jarvis", "Johnston", "Kingman", "Palmyra", "Wake"), 12, ncrmp_utm_zones$Satellite)
ncrmp_utm_zones$Satellite = ifelse(ncrmp_utm_zones$Island %in% c("Tutuila"), 11, ncrmp_utm_zones$Satellite)
ncrmp_utm_zones$Satellite = ifelse(ncrmp_utm_zones$Island %in% c("Hawaii"), 10, ncrmp_utm_zones$Satellite)
