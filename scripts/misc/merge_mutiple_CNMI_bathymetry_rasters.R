...
files <- list_files_with_exts("/Users/kisei.tanaka/Desktop/cnmi2019_islands_Job1075101/", "tif")
...
files <- list_files_with_exts("N:/GIS/Projects/CommonMaps/Bathymetry/cnmi2019_islands/3m_res/", "tif")
merge_rasters(files[1:13], output_raster = "N:/GIS/Projects/CommonMaps/Bathymetry/cnmi_merged_3m_res.tif", overwrite = T)
plot(rast("N:/GIS/Projects/CommonMaps/Bathymetry/cnmi_merged_3m_res.tif"))
